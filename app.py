...
def performance(period):
    ...
    fig_rf = GraphBTC("RandomForest", performance_rf, [period]).get_graph()
    fig_ab = GraphBTC("AdaBoost", performance_ab, [period]).get_graph()
    fig_gb = GraphBTC("GradientBoost", performance_gb, [period]).get_graph()
